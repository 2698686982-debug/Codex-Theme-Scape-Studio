...
- 第 1 款必须是瑞克与莫蒂主题，第 2 款必须是火影忍者主题，第 3 款必须是蓝白高达轨道指挥中心；第 6–9 款必须是太空冒险、多元宇宙、庄园悬疑和时间旅行四个剧情主题，分别采用横向发射甲板、2×2 传送门选集、不对称证据板和纵向时间线；刷新、切换任务和重新启动后应保留上次选择；
...
- 主题中心必须可以直接上传 PNG、JPEG 或 WebP，在本机完成压缩和自动取色，允许选择十二种布局并调整强调色、辅助色、面板色和文字色；上传主题保存到本机且可删除，不得覆盖 20 款内置主题；
...
- 实际使用的主题名和素材文件；
- 右上角主题中心是否包含永久系统默认入口和完整 20 款、火影忍者是否为第 2 款、十二类布局是否生效，以及主题/默认双向切换和刷新持久化是否通过；
